        ...
        <div class="w-full max-w-[440px]">
            ...
            <div
                ...
                @error(config('fortify.username'))
                    <div class="mb-4 font-ui-label text-ui-label text-error">
                        {{ $message }}
                    </div>
                @enderror
                <form action="{{ route('login.store') }}" method='post' class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input
                            ...
                            id="email" name="{{ config('fortify.username') }}" placeholder="name@domain.com" required="" type="email" />
                    </div>
                    <!-- Password Field -->
                    <div class="space-y-2">
                ...
                <div class="mt-10 text-center">
                    <p class="font-ui-label text-ui-label text-on-surface-variant">
                        New to Ink &amp; Paper?
                        <a class="text-primary font-bold hover:underline transition-all ml-1" href="{{ route('register') }}">Create an
                            Account</a>
                    </p>
                </div>
            </div>
