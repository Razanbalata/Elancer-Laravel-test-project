        ...
        <article
            ...
            <div class="p-8 space-y-4">
                ...
                <p class="text-on-surface-variant font-body-md text-body-md line-clamp-3">In an era of digital
                    noise, the
                    most powerful statement a brand can make is silence. We explore the structural psychology behind
                    'Paper
            ...
            <article class="flex flex-col md:flex-row gap-8 group">
                ...
                <div class="w-full md:w-2/3 space-y-3">
                    ...
                    <p class="text-on-surface-variant font-body-md text-body-md line-clamp-2">How modern
                        high-resolution
                        displays are bringing back the elegance of the serif, and why readability is the new luxury.
                    </p>
            ...
            <article class="flex flex-col md:flex-row gap-8 group">
                ...
                <div class="w-full md:w-2/3 space-y-3">
                    ...
                    <p class="text-on-surface-variant font-body-md text-body-md line-clamp-2">Reducing cognitive
                        load
                        through environmental design. Learn how to strip away the non-essential from your workflow.
                    </p>
                    <div class="flex items-center gap-3 pt-2">
